...
<body>
    ...
    <div style="padding-top:30px; display:flex">
        <div class="box" style="margin-left:15%; margin-right:8%; width: auto; height:320px;">
            ...
            <br><h3 style="text-align: center;">Chef</h3>
        </div>

        <div class="box">
            <div>
                <p className="small text-muted mb-1">
                    Username : <strong style="margin-left:10px">
                            <?php 
    ...
    <div style="margin-top:50px; border: solid 1px red; padding: 2% 2% 2% 2%;">
        <h4 style="text-align:center; background-color:red; height:50px; padding-top:10px">Posts</h4>
