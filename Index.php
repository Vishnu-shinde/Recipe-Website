...
<body>
    <nav class="navbar navbar-expand-lg navbar-light container-fluid" style="background-color: #C5CBE3;">
    ...
    <div style="display: flex;">
        ...
        <div class="box" style="margin-left:15%; margin-right:10%; width: auto;height:360px;">
        ...
        <form action="server.php" method="post" autocomplete="off" class="box" style="height: 360px;">
            <h1 style="text-align:center; margin-top: 0px;">Login</h1><br><br>
            <label for="username" style="margin-right: 10px;">Username</label>
            <input type="text" id="username" name="username" placeholder="Enter Username" class="inp-control" Required><br>
            <label for="Password" style="margin-right: 15px;">Password</label>
            <input type="password" id="password" name="password" placeholder="Enter Password" class="inp-control" Required><br>
            <input type="checkbox" onclick="myFunction()" style="margin-top:20px"> Show Password <br>
            <button class="button" name="login" type="submit">Submit</button>
        </form>
    </div>
</body>
</html>