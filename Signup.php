...
<body>
    ...
    <div style="display: flex;">
        ...
        <form action="server.php" method="post" class="box" autocomplete="off">
            <h1 style="text-align:center; margin-top: 0px;">Register Yourself</h1><br><br>
            <label for="username" style="margin-right: 35px;">Username</label>
            <input type="text" id="username" name="username" placeholder="Enter Name" class="inp-control" Required><br>
            <label for="email" style="margin-right: 70px;">Email</label>
            <input type="email" name="email" id="email" placeholder="Enter Email-id" class="inp-control" Required><br>
            <label for="password" style="margin-right: 42px;">Password</label>
            <input type="password" name="password" id="password" placeholder="Enter password" class="inp-control" Required><br>
            <label for="cpassword" style="margin-right: 5px;">Confirm Password</label>
            <input type="password" style="width:352px" name="cpassword" id="cpassword" placeholder="ReEnter password" class="inp-control" Required><br>
            <input type="checkbox" onclick="myFunction()" style="margin-top:20px"> Show Password <br>
            <button class="button" name="subbut" type="submit">Submit</button>
        </form>
    </div>
</body>
</html>